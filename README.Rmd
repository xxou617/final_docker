...
3. Run `make run_report_mac` or `run_report_win` in terminal and then get the report in `report` folder
...
2. Run `make run_report_mac` or `run_report_win` in terminal and then get the report in `report` folder
